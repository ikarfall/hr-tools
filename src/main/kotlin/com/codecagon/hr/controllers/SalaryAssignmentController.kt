...
class SalaryAssignmentController(@Autowired val salaryAssignmentService: SalaryAssignmentService,
    ...
    @GetMapping
    fun getAllByPerson(@PathVariable id: UUID): List<SalaryAssignmentResponse>
            = salaryAssignmentService.getAllByPerson(id) then (salaryAssignmentMapper::toResponse)

    @PostMapping
    fun addAssignment(@PathVariable id: UUID, assignment: SalaryAssignmentRequest)
            = assignment
    ...
    fun deleteAssignment(@PathVariable id: UUID, assignmentId: UUID)
            = salaryAssignmentService.deleteAssignment(id, assignmentId)
